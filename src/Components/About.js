...
function About() {
    ...
    const technologies = {
        ...
        2: {name: 'HTML 5', img: {src: htmlPNG, h: 80,w: 80},  description: "HTML5 (Hyper Text Markup Language) is the basic language of the web. Today, it’s important to use semantic HTML to make the web accessible."},
